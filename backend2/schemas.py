...
from typing import Optional   # Optional → 값이 있을 수도 있고 없을 수도 있는 필드 정의
from datetime import datetime # 날짜/시간 타입 (created_at 등에 사용)
...
class UserResponse(BaseModel):  
    ...
    class Config:  
        orm_mode = True       # SQLAlchemy ORM 객체 → 자동으로 JSON 변환(예: User 객체 그대로 return 가능)
...
class PostResponse(BaseModel):  
    ...
    # class Config:  
    #     orm_mode = True       # ORM 객체를 그대로 반환 가능
